...
/*      selectErrors () {
  ...
  cityErrors () {
    ...
    if (!this.$v.city.$dirty) return errors
      !this.$v.city.maxLength && errors.push('Current City must be at most 25 characters long')
...
jobProfileErrors () {
    ...
    if (!this.$v.jobProfile.$dirty) return errors
      !this.$v.jobProfile.maxLength && errors.push('Job Profile must be at most 50 characters long')
...
jobLocationErrors () {
    ...
    if (!this.$v.jobLocation.$dirty) return errors
      !this.$v.jobLocation.maxLength && errors.push('Expected Job Location must be at most 10 characters long')
  !this.$v.jobLocation.required && errors.push('Expected Job Location is required.')
...
salaryErrors () {
  ...
  !this.$v.salary.maxLength && errors.push('Must be of length less than 10.')
  return errors
},
phoneErrors () {
    const errors = []
  ...
  !this.$v.phone.maxLength && errors.push('Must be of length less than 10.')
  return errors
}
},
